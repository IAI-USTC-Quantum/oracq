...
\item \textbf{A numerical verification campaign on real backends}
  (\secref{sec:implementation}): 473 experiments in thirteen groups cover
...
defects, and the deliberately reserved parts (validation at scale and
resource estimation).  \secref{sec:discussion} discusses limitations and future work.
