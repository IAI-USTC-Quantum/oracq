...
the whole is a module graph of reviewable size.  Its physics is certified
at the fixed-point level against an independently written fixed-point
semantics (\secref{sec:numverify}), with generation-time constant
quantization recorded as the dominant method error.
