...
**English** · [简体中文](../zh/tutorials/scientific-workflows.html)
...
Mathematical conventions and interfaces are on the [Carleman page](../zh/manual/algorithms/carleman.html).
...
method configuration and applicability conditions are on the [LCHS page](../zh/manual/algorithms/lchs.html).
...
Nodes, residues, the finite truncation, and the omitted terms are on the [CBMD page](../zh/manual/algorithms/cbmd.html).
...
| The wider algorithm catalog and validation status | [Algorithm catalog](../zh/manual/algorithms/index.html), [validation coverage](../development/validation-coverage.md) |
