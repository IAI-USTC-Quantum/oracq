...
| 编号 | 工作项 | 状态 | 证据 |
|---|---|---|---|
| P0 | 盘点 QECC.Lang 文档与用例，建立覆盖矩阵 | done | [coverage.json](../docs/coverage.json)、[coverage.md](../docs/coverage.md) |
| P1 | RIR 0.2：开放 oracle 声明、部分绑定、缺口报告和闭合导出 | done | [linking.py](../src/pyqecclang/linking.py)、[open-ir.md](../docs/open-ir.md)、[test_open_ir.py](../tests/core/test_open_ir.py) |
| P2 | BE、XOR database、state-prep isometry、CKS sparse 等范式 | done | [oracles.py](../src/pyqecclang/oracles.py)、[oracle-paradigms.md](../docs/oracle-paradigms.md) |
| P3 | Gate/QRAM 基础实现与组合适配器 | done | [access.py](../src/pyqecclang/access.py)、[combinators.py](../src/pyqecclang/combinators.py) |
| P4 | Deutsch–Jozsa、Grover 抽象与具体组装 | done | [elementary.py](../src/pyqecclang/algorithms/elementary.py) |
| P5 | Costa QLSS walk、调度、filtering 及实例绑定 | done | [costa.py](../src/pyqecclang/algorithms/costa.py) |
| P6 | QFVM 输入访问与 QLSS 组装 | done | [applications.py](../src/pyqecclang/applications.py)、[program.originir](../out/catalog/qfvm_qram/program.originir) |
| P7 | QODE/QPDE 与 QHAM 提升系统组装 | done | [solvers.py](../src/pyqecclang/algorithms/solvers.py)、[program.originir](../out/catalog/qham_qode/program.originir) |
| P8 | 覆盖面板、开放/闭合 IR 和 OriginIR-ext 示例产物、结构验收 | done | [build_catalog.py](../tools/build_catalog.py)、[test_workloads.py](../tests/core/test_workloads.py)、[test_catalog.py](../tests/integration/test_catalog.py)、[phase-validation.json](../docs/phase-validation.json) |
