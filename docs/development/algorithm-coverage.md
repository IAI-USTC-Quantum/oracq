...
**English** · [简体中文](../zh/development/algorithm-coverage.html)
...
- Per-algorithm implementation and validation details live on the [algorithm
  pages](../zh/manual/algorithms/index.html); update the corresponding pages
