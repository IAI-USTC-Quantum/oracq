...
`QVector` 与 `QMatrix` 封装 QFVM（arXiv:2102.03557 式 15–22 残差平方和树）与 Kerenidis–Prakash 推荐系统（arXiv:1603.08675 Thm 5.1 + 附录 A.1）共用的量子数据结构，数据面全部经由 [QRAM 指针访问](qmem.md)。
