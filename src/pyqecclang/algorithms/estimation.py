...
from pyqecclang.algorithms.interfaces import as_block_encoding, checked_state_preparation
from pyqecclang.algorithms.operators import _name
from pyqecclang.algorithms.oracles import basis_state, invoke, resources_for
...
def amplitude_estimation(preparation, marked, *, precision=3):
    ...
    from pyqecclang.algorithms.search import grover_iterate
