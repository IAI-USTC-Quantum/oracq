...
from pyqecclang.algorithms.block_encoding import lcu, pauli_word
...
from pyqecclang.algorithms.interfaces import BlockEncodingProtocol, as_block_encoding
from pyqecclang.algorithms.operators import BlockEncoding, _name, block_encoding, identity, product
