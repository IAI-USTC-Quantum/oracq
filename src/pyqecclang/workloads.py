...
from .access import batch_lookup, reversible_lookup, sparse_block_encoding, word_rotation
from .algorithms.costa import CostaConfig, costa_qlss, make_costa_qlss
from .algorithms.elementary import (
    deutsch_jozsa,
    grover,
...
from .algorithms.solvers import make_euler_history_qode, make_lchs_qode, make_qpde
from .applications import qfvm_inputs, qfvm_step, qham_initial_vector, qham_lift_m1, qham_m1
from .builder import Builder
from .combinators import direct_sum, kronecker_sum, lcu, matrix_pauli_encoding, pad_signal, tensor
from .ir import Bits, Program
from .library import identity, pauli_x
...
from .readout import ReadoutAction
...
class Case:
    ...
    def artifact(self):
        from .backends import export_originir
...
def build_case(name):
    ...
    if name == "trotter_hamsim":
        from .algorithms.solvers import trotter_hamsim
    ...
    if name == "schrodingerisation":
        from .algorithms.solvers import make_schrodingerisation_qode
    ...
    if name == "banked_qram":
        from .oracles import banked_database
    ...
    if name.startswith("grover_"):
        from .algorithms.elementary import phase_from_database
