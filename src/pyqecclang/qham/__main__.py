"""python -m pyqecclang.qham：PDE JSON 到一般 QCL 推导。"""

import argparse
import json
from pathlib import Path

from .examples import example_pde
from .linearization import Block, QHAMPlan
from .pde import PolynomialPDE
from .report import export_derivation
