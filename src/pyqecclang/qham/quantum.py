...
from ..combinators import lcu, matrix_pauli_encoding
from ..ir import Bits, ValidationError
from ..library import BlockEncoding, _name, identity, product, zero
from ..oracles import (
    StateOracle,
    StatePreparation,
...
from .linearization import Block
...
def taylor_qode(generator, initial, time, *, degree=2):
    ...
    from ..algorithms.solvers import apply_be_to_state
