...
from ..execution import LocalEnter, LocalExit, RegisterState, check_memory, events, gate_matrix
from ..ir import Load, ValidationError
from ..native import NativeContext, NativeSite
from ..validation import locations, validate
...
def run_pysparq(
    ...
    *,
    ...
    # 在接管全局注册表前完成展开预算检查。
    from ..execution import expanded_steps
