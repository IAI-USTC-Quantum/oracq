...
from ..ir import Adjoint, Call, Control, Load, Primitive, Program, Repeat, ValidationError
...
class _Exporter:
    def __init__(self, program):
        ...
        self.definitions = []
        self.cache = {}
        from ..layout import workspace_table
...
def run_originir(program: Program, memory=None, *, max_qubits=24, max_steps=1_000_000):
    ...
    from ..execution import check_memory, expanded_steps
